...
/*
** Escribe un entero en el fd dado (sin newline).
*/
...
/*
** Escribe un double con dos decimales en el fd dado.
*/
...
/*
** Imprime una línea de benchmark: "[bench] label: valor\n"
*/
...
/*
** Calcula el total de operaciones sumando todos los contadores.
*/
...
/*
** Imprime el resumen completo del benchmark a stderr.
** Solo se llama cuando --bench está activo.
*/
